                    ...
                    <div className="grid grid-flow grid-rows-1 gap-1">
                        <div className="group relative w-full p-6 bg-white border border-gray-200 rounded-lg shadow flex items-center border-b justify-between transition-colors overflow-hidden">
                            ...
                            <div className="flex items-center space-x-4">
                                {/* Ảnh sản phẩm */}
                                <img src="https://s3-alpha-sig.figma.com/img/b42e/d042/90c7242704c7a44daa1256b01285b8d1?Expires=1740355200&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=nXaOP4uBB124rwraCk4u0rTxtol7r6ZGjejZc39XocgTdmZJcXtkXIi5dbzW60H1UayVV~EyFgavdmVoirHVN8WNisbkOOdWauqvEHI49WnvdeLktZrsA69ko4ITu5ywzuhoZXCIGHPBJgxO59H8ZxEKR~30Xt9eYVzc-UsQBR-ONUOT8RFAoOlSGok1WEiznaK3hbccqgHpG8XCZ-1Azv7gj~8l-jEUW8krqImxaYrBX9GBdm4TtYhQE-BXriXHevyCJ~lYA0890yLgPgCUDbzHjkPXhhB54nEyZBP5RbFjoJl2BptIt3eRd3WcZOQHzKP2ELf2WsTdE9wmEh5pdQ__" alt="Product Image" className="w-40 h-40 rounded-lg" />

                                {/* Chi tiết sản phẩm */}
                                <div>
                                    <p className="font-bold text-lg">No5 Chanel Paris (Chai 10ml)</p>
                                    <p className="font-semibold text-gray-500  pt-0 px-1 pb-10 text-lg">Pink</p>
                                    <p className="font-semibold text-lg" style={{ color: 'rgba(255, 96, 121, 0.7)' }}>159,000 VND</p>
                                </div>
                            </div>
                            ...
                            <div className="absolute  right-12 top-1/2 transform -translate-y-1/2 text-white px-4 py-2 rounded-lg space-x-4 group-hover:right-56 transition-all duration-300 ease-in-out">
                                ...
                                <div className="text-lg flex items-center">
                                    <button className="font-bold bg-gray-200 text-gray-700 px-3 py-1 rounded-l" style={{ color: 'rgba(255, 96, 121, 0.7)' }}>-</button>
                                    <span className="font-bold bg-gray-100 text-gray-700 px-4 py-1">1</span>
                                    <button className="font-bold px-3 py-1 rounded-r " style={{ backgroundColor: 'rgba(255, 96, 121, 0.7)' }}>+</button>
                                </div>
                            </div>
                        ...
                        <div className="group relative w-full p-6 bg-white border border-gray-200 rounded-lg shadow flex items-center border-b border-gray-200 justify-between transition-colors overflow-hidden">
                            <div className="flex items-center space-x-4">
                                <img src="https://s3-alpha-sig.figma.com/img/b42e/d042/90c7242704c7a44daa1256b01285b8d1?Expires=1740355200&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=nXaOP4uBB124rwraCk4u0rTxtol7r6ZGjejZc39XocgTdmZJcXtkXIi5dbzW60H1UayVV~EyFgavdmVoirHVN8WNisbkOOdWauqvEHI49WnvdeLktZrsA69ko4ITu5ywzuhoZXCIGHPBJgxO59H8ZxEKR~30Xt9eYVzc-UsQBR-ONUOT8RFAoOlSGok1WEiznaK3hbccqgHpG8XCZ-1Azv7gj~8l-jEUW8krqImxaYrBX9GBdm4TtYhQE-BXriXHevyCJ~lYA0890yLgPgCUDbzHjkPXhhB54nEyZBP5RbFjoJl2BptIt3eRd3WcZOQHzKP2ELf2WsTdE9wmEh5pdQ__" alt="Product Image" className="w-40 h-40 rounded-lg" />
                                <div>
                                    <p className="font-bold text-lg">Nước Hoa Jean Paul Gaultier Scandal EDP 30ML</p>
                                    <p className="font-semibold text-gray-500  pt-0 px-1 pb-10 text-lg">01 Blossom Forest</p>
                                    <p className="font-semibold text-lg" style={{ color: 'rgba(255, 96, 121, 0.7)' }}>889,000 VND</p>
                                </div>
                            </div>
                            <div className="absolute  right-12 top-1/2 transform -translate-y-1/2 text-white px-4 py-2 rounded-lg space-x-4 group-hover:right-56 transition-all duration-300 ease-in-out">
                                <div className="text-lg flex items-center">
