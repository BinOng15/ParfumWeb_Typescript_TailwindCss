...
import SignupModal from "../sigup/sigup";
        ...
        <>
            <header className="flex items-center justify-between px-6 py-4 bg-white shadow-md">
                ...
                <div className="ml-[250px]">
                    <img src="public/Screenshot 2024-12-20 150332.png" alt="EundeParfum" className="h-12 w-auto" />
                </div>
                <div className="flex items-center space-x-4">
                    ...
                    <Button className="border-gray-300" type="default" onClick={showSignupModal}>
                        Đăng ký
                    </Button>
                    <Button className="border-gray-300" type="default" onClick={showLoginModal}>
                        Đăng nhập
                    </Button>
                </div>
            </header>
            <nav className="flex justify-center space-x-6 text-gray-800 font-medium bg-white shadow-md py-3">
                ...
                <Link to="/perfume" className="relative hover:text-pink-600 text-center">
                    NƯỚC HOA
